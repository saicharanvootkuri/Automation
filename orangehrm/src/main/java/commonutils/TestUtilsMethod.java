...
public class TestUtilsMethod {
	private static final Logger log = Logger.getLogger(TestUtilsMethod.class.getName());
	...
	public void getScreenshot() throws IOException {
		...
		log.info("Screenshot captured and saved at: C:\\Users\\Admin\\Downloads\\TestFailSnaps" + screenshotFilename+ ".png");
	}
